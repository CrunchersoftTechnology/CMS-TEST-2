        ...
        public static void RegisterGrids()
        {
            ...
            MVCGridDefinitionTable.Add("BoardGrid",
                     ...
                     .WithRetrieveDataMethod((context) =>
                  {
                      ...
                      string globalSearch = options.GetAdditionalQueryOptionString("search");
                      string sortColumn = options.GetSortColumnData<string>();
                      var items = repo.GetBoardData(out totalRecords, options.GetFilterString("BoardName"),
            ...
            MVCGridDefinitionTable.Add("BranchGrid",
                  ...
                  .WithRetrieveDataMethod((context) =>
                  {
                      ...
                      string globalSearch = options.GetAdditionalQueryOptionString("search");
                      string sortColumn = options.GetSortColumnData<string>();
                      var items = repo.GetBranchData(out totalRecords, options.GetFilterString("BranchName"),
                                      options.GetLimitOffset(), options.GetLimitRowcount(),
                          sortColumn, options.SortDirection == SortDirection.Dsc);
         ...
         .WithRetrieveDataMethod((context) =>
         {
             ...
             string globalSearch = options.GetAdditionalQueryOptionString("search");
             string sortColumn = options.GetSortColumnData<string>();
             var items = repo.GetSubjectData(out totalRecords, options.GetFilterString("SubjectName"), Convert.ToInt16(options.GetFilterString("ClassName")),
                             options.GetLimitOffset(), options.GetLimitRowcount(),
                 sortColumn, options.SortDirection == SortDirection.Dsc);
